...
public class AdminWaypointActionMenu {
    public static void open(Player player, UUID targetUuid, int waypointId, ViodRealmsTPU plugin) {
    ...
    private static void render(Player player, UUID targetUuid, Waypoint waypoint, ViodRealmsTPU plugin) {
        if (waypoint == null) {
