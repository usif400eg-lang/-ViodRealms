...
public class MainMenu {
    public static void open(Player player, int count, int max, VoxelPanel plugin) {
        Inventory inventory = Bukkit.createInventory(null, 27, ChatColor.DARK_GRAY + "VoxelPanel");
        GUIUtils.fillBackground(inventory);
        inventory.setItem(4, GUIUtils.label("&fVoxelPanel", List.of("&7Waypoints: &f" + count + " &7/ &f" + max)));
