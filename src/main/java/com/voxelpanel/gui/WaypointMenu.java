...
public class WaypointMenu {
    ...
    public static void open(Player player, VoxelPanel plugin, String category) {
        open(player, plugin, category, 0);
    }

    public static void open(Player player, VoxelPanel plugin, String category, int page) {
    ...
    private static void render(Player player, List<Waypoint> waypoints, VoxelPanel plugin, String category, int page) {
