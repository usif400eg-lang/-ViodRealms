...
public class AdminWaypointMenu {
    public static void open(Player player, UUID targetUuid, VoxelPanel plugin, int page) {
    ...
    private static void render(Player player, UUID targetUuid, List<Waypoint> waypoints, VoxelPanel plugin) {
