...
public final class ImportExportUtil {
    ...
    private static File getExportsDir(VoxelPanel plugin) {
    ...
    public static int exportWaypoints(VoxelPanel plugin, UUID playerUuid, String fileName, List<Waypoint> waypoints) {
    ...
    public static List<Waypoint> importWaypoints(VoxelPanel plugin, UUID playerUuid, String playerName, String fileName) {
        File file = new File(getExportsDir(plugin), fileName + ".yml");
        if (!file.exists()) {
            return null;
        }
