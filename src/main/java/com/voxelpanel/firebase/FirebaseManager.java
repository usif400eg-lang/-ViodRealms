...
public class FirebaseManager {
    ...
    public FirebaseManager(VoxelPanel plugin) {
        this.plugin = plugin;
    }

    /** Attempts to initialize the Firebase connection. Returns true on success. */
    public boolean initialize() {
        // Prefer the new web.* keys; fall back to legacy firebase.* for old configs.
        String databaseUrl = plugin.getConfig().getString("web.url",
